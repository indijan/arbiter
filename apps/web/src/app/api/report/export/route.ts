...
type ExportType = "latest" | "24h" | "7d" | "strategy";
...
export async function GET(request: NextRequest) {
  ...
  const type = (["latest", "24h", "7d", "strategy"].includes(typeParam) ? typeParam : "latest") as ExportType;
  ...
  if (type === "strategy" && key) opportunitiesQuery = opportunitiesQuery.eq("type", key);
