...
const SYMBOLS = ["BTCUSD", "SOLUSD", "XRPUSD", "AVAXUSD"];
...
const SOL_SOFT_BULL_MAX_ALT_MOMENTUM_6H_BPS = 140;
const SOL_SOFT_BULL_MIN_ALT_MOMENTUM_2H_BPS = 10;
const SOL_SOFT_BULL_MIN_SPREAD_BPS = -25;
const SOL_SOFT_BULL_MAX_SPREAD_BPS = 35;
